    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('producto_variante', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='almacen.productovariante')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('completada', 'Completada'), ('anulada', 'Anulada'), ('devuelta', 'Devuelta')], default='completada', max_length=20)),
